...
function Contact() {
  ...
  async function submit(e: FormEvent<HTMLFormElement>) {
   ...
   var pk = siteConfig.customFields.emailJsPk as string;
    ...
    emailjs.send(serviceId, templateId, template, pk)
        .then((result) => {
          setEmail("");
          setName("");
          setMessage("");
      ...
      <div className="container margin-vert--lg">
        <div className="row">
          <div className="col col--6 col--offset-3">
            <h1>Contact Me</h1>
            <p>If you have any comments, ideas, critiques, or you just want to say hi, don’t hesitate to send me an email at 
              <a href="mailto:sudo@suleymandonmez.dev">sudo@suleymandonmez.dev</a> or fill the form below!</p>
